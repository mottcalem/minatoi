...
export function WhatsAppButton({ message, className = "", children, size = "md", variant = "solid" }: Props) {
  const sizes = {
...
export function WhatsAppFloating() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 grid h-14 w-14 place-items-center rounded-full bg-whatsapp text-whatsapp-foreground shadow-elegant hover:scale-105 transition"
    >
