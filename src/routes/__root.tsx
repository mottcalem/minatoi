...
(function(d,t) {
  ...
  g.onload=function(){
    ...
    meta: [
      ...
      { property: "og:image", content: "https://minatoi.dijitalpanter.com/images/og-image.jpg" },
      ...
      { name: "twitter:image", content: "https://minatoi.dijitalpanter.com/images/og-image.jpg" },
    ],
    links: [
      ...
      { rel: "canonical", href: "https://minatoi.dijitalpanter.com" },
