...
export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://minatoi.dijitalpanter.com/blog" },
      { name: "robots", content: "index, follow" },
    ],
    links: [{ rel: "canonical", href: "https://minatoi.dijitalpanter.com/blog" }],
  }),
  component: BlogIndex,
});
...
function BlogIndex() {
  ...
  const jsonLd = {
    ...
    url: "https://minatoi.dijitalpanter.com/blog",
    publisher: {
      "@type": "Organization",
      name: "MinaToi",
    ...
    blogPost: BLOG_POSTS.map((p) => ({
      "@type": "BlogPosting",
      headline: p.title,
      url: `https://minatoi.dijitalpanter.com/blog/${p.slug}`,
